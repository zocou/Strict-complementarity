# Hock -Schittkowski collection problem number 55
# Solution                         : x* = (0, 4/3, 5/3, 1, 2/3, 1/3)
# Optimal value                    : f(x*) = 19/3
# Active constraints at x*          : x[1] >= 0, 1 - x[4] >= 0
# Lagrange multipliers umax*/umin* : / = 

#   classification OOR2-MN-6-12
...
subject to bdsconst{j in 1..6}: 0 <= x[j] <= u[j]; 
