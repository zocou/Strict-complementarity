# Schittkowski test set problem number s 268
# Solution                         : x* = (1, 2, - 1,3, - 4)
# Optimal value                    : f(x*) = 0
# Active constraints at x*          : cons5
# Lagrange multipliers umax*/umin* : 1/0 = 
# Non strictly complementary constraints : cons5

# classification : LLR2-MN-5-5
